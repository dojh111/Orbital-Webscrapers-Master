...
const webScraper = async () => {
    ...
    console.log("Start Writing Condensed Data")
    let jsonInitialise = JSON.stringify(scrapedDataOBJ);
    fs.writeFile('test.json', jsonInitialise, () => { console.log("Write Done") });
    ...
    for (let recipe of scrapedDataOBJ.data) {
        ...
        console.log('---------------------------------' + 'End' + '---------------------------------');
        //Adding onto object
        scrapedAdditional.data[recipe.id].ingredient = ingredientArray;
        scrapedAdditional.data[recipe.id].originalIngredient = OriginalIngredientArray;
    ...
    console.log("Start Writing Additional Data")
    let jsonInitialiseTwo = JSON.stringify(scrapedAdditional);
    fs.writeFile('testAdditional.json', jsonInitialiseTwo, () => { console.log("Write Done") });
}
